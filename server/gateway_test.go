...
func (l *captureGWInterestSwitchLogger) Noticef(format string, args ...interface{}) {
	...
	if strings.Contains(msg, fmt.Sprintf("switching account %q to %s mode", globalAccountName, InterestOnly.String())) ||
		strings.Contains(msg, fmt.Sprintf("switching account %q to %s mode complete", globalAccountName, InterestOnly.String())) {
